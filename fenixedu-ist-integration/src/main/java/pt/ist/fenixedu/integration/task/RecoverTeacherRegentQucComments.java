...
public class RecoverTeacherRegentQucComments extends CustomTask {

    private List<String> getUnalteredResults() throws Exception {
        GroupBasedFile qucResults = FenixFramework.getDomainObject("563568428715607");
    ...
    public void runTask() throws Exception {
        ...
        for (int iter = 0; iter < allRows.length; iter++) {
            ...
            if (unalteredResults.contains(result)) {
                ...
                if (inquiryResult != null) {
                    ...
                    if (commentData.getPersonCatergory().equals(ResultPersonCategory.TEACHER)
                            || commentData.getPersonCatergory().equals(ResultPersonCategory.REGENT)) {
        ...
        output("recovered_teacher_regent_comments.csv", recoveredComments.toString().getBytes());
    }
